<div class="modal fade" id="delete{{ $supplier->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button wire:click='delete({{ $supplier->id }})' type="button" class="btn btn-primary"
