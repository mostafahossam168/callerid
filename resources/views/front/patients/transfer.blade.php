    ...
    <div class="modal-dialog modal-lg">
        <div id="prt-contenst" class="modal-content">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4 text-end">
                        ...
                        <select wire:model="doctor_id" class="main-select w-100 trans-select-color" id="">
                            ...
                            @foreach ($clinic_id ? \App\Models\User::whereHas('departments',function($q) use ($clinic_id){ $q->where('departments.id',$clinic_id); })->get() : [] as $doctor)
                    ...
                    {{-- <div class="col-12">
                        <div class="row">
                            <div class="col-md-3 ">
                                ...
                                <input type="text" wire:model="sugar_rate" class="form-control">
                            </div>
                            <div class="col-md-3">
                                <label class="small-label" for=""> {{__('admin.the weight')}}</label>
                                <input type="text" wire:model="pressure_rate" class="form-control">
                            </div>
                            <div class="col-md-3">
            ...
            <div class="modal-footer">
                ...
                <button wire:click="submit_transfer()" class="btn-main-sm px-5" data-bs-dismiss="modal">{{
					__('transfer') }}</button>
            </div>
        </div>
    </div>
