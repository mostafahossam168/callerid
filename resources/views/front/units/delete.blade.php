<div class="modal fade" id="delete{{ $unit->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button wire:click='delete({{ $unit->id }})' type="button" class="btn btn-primary"
