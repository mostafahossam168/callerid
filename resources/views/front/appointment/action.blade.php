 {{-- modal bulk delete --}}
    ...
    <form  class="my-1 my-xl-0" action="{{ route('front.appointments.bulk_delete','ids') }}" method="post" style="display: inline-block;" autocomplete="off">
        @csrf
        @method('delete')
        <div class="modal fade" id="bulkdelete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                {{__('admin.Do you want to clear all converters?')}}
