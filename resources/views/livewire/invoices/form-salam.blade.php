        ...
        <div class="page">
            ...
            <div class="content">
                <div class="text align-items-center">
                    ...
                    <h4 class="mb-0">{{__('admin.Simplified tax invoice')}}</h4>
                </div>
            </div>
            <table>
                <tr>
                    ...
                    <td colspan="4">
                        <div>
                            <span class="rig"><strong>أسم المالك</strong>:
                                {{ $invoice->patient->name }}</span>
                            <span dir="ltr" class="lef"><strong>Owner Name</strong>:-</span>
                        </div>
                    </td>
                    ...
                    <td colspan="4">
                        <div>
                            <span class="rig"><strong>العمر</strong>:
                                24</span>
                            <span dir="ltr" class="lef"><strong> Years</strong>:-</span>
                        </div>
                    </td>
                    <td colspan="4">
                        <div>
                ...
                <tr>
                    ...
                    <td rowspan="5">
                        <div class="qr-table-holder">{!! $qrCode !!}</div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        @else
                        <span class="rig pir-r"><strong>الصافي </strong></span>
                        @endif
