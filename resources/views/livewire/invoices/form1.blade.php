...
<style>
    ...
    .watermark {
        ...
        pointer-events: none;
        /* Ensure watermark does not interfere with other elements */
    }
        ...
        <div class="page">
            <div class="content">
                <div class="text align-items-center justify-content-between  mt-1 mb-2 ">
                    <div class="text-end ">
                        ...
                        <div class="me-1"><b>الرقم الضرريبي: </b> {{ setting()->tax_no }}</div>
                    ...
                    <div class="">
                        @if($invoice->patient)
                        <div class="me-1">العميل: {{ $invoice->patient?->name }}</div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td rowspan="2"><strong>تحويل بنكى-Bank transfer</strong><br />{{ $invoice->bank }}</td>
                </tr>
                <tr>
                    <td colspan="2">
                    </td>
