    ...
    <form class="row row-gap-24 p-3 shadow rounded-3 bg-white w-100 mx-auto" action="{{ route('admin.patients.store') }}"
        ...
        <div class="col-sm-6 col-md-4">
            ...
            <input type="date" class="form-control" value="{{ old('date') }}" name="date"
                placeholder="{{ __('admin.The date the record was added') }}">
        </div>
        <div class="col-sm-6 col-md-4">
            <label class="main-lable" for="">
                {{ __('admin.Civil number') }}
            </label>
            <input type="number" class="form-control" value="{{ old('civil') }}" name="civil"
                placeholder="{{ __('admin.Civil number') }}">
        </div>
        <div class="col-sm-6 col-md-4">
            <label class="main-lable" for="">
                {{ __('admin.phone') }}
        ...
        <div class="col-sm-6 col-md-3">
            ...
            <input type="text" class="form-control" value="{{ old('first_name') }}"
                placeholder="{{ __('admin.name') }}" name="first_name">
        </div>
        <div class="col-sm-6 col-md-3">
            <label class="main-lable" for="">
        ...
        <div class="col-sm-6 col-md-3">
            ...
            <select name="relationship_id" class="main-select w-100" id="">
                @foreach ($relationships as $relationship)
                    <option {{ old('relationship_id') && old('relationship_id') == $relationship->id ? 'selected' : '' }}
        ...
        <div class="col-sm-6 col-md-3">
            ...
            <select name="gender" class="main-select w-100" id="">
                <option {{ old('gender') && old('gender') == 'male' ? 'selected' : '' }} value="male">
                    {{ __('admin.male') }}</option>
                <option {{ old('gender') && old('gender') == 'female' ? 'selected' : '' }} value="female">
        ...
        <div class="col-sm-6 col-md-3">
            ...
            <select name="country_id" class="main-select w-100" id="">
                <option value="">اختر {{ __('admin.country') }}</option>
                @foreach ($countries as $country)
                    <option {{ old('country_id') && old('country_id') == $country->id ? 'selected' : '' }}
        ...
        <div class="col-sm-6 col-md-3">
            ...
            <select name="" class="main-select w-100" id="">
        ...
        <div class="col-sm-6 ">
            ...
            <input type="date" value="{{ old('birthdate') }}" name="birthdate" class="form-control" id="">
        </div>
        <div class="col-sm-6 ">
            <label class="main-lable" for="">
                {{ __('admin.Age') }}
            </label>
            <input type="number" value="{{ old('age') }}" name="age" placeholder="{{ __('admin.Age') }}"
        ...
        <div class="col-sm-6 ">
            <div class="row row-gap-24">
                <div class="col-12">
                    ...
                    <input type="text" value="{{ old('near_name') }}" name="near_name"
                        placeholder="{{ __('admin.The name of a relative') }}" class="form-control" id="">
                </div>
                <div class="col-12">
                    <label class="main-lable" for="">
                        {{ __('admin.The mobile of a relative') }}
                    </label>
                    <input type="number" value="{{ old('near_mobile') }}" name="near_mobile"
                        placeholder="{{ __('admin.The mobile of a relative') }}" class="form-control" id="">
                </div>
            </div>
        </div>
        <div class="col-sm-6 ">
            ...
            <textarea class="form-control" name="notes_health_record" placeholder="{{ __('admin.Notes on the health record') }}"
                id="" rows="5">{{ old('notes_health_record') }}</textarea>
        </div>
        ...
        <div class="col-sm-6 ">
            ...
            <textarea class="form-control" name="goal_of_visit" id="" rows="9"
                placeholder="{{ __('admin.the purpose from the visit') }}">{{ old('goal_of_visit') }}</textarea>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <textarea name="other_diseases" placeholder="{{ __('admin.other diseases') }}" id="" class="form-control"
                rows="5">{{ old('other_diseases') }}</textarea>
        </div>
