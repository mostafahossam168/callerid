...
<nav aria-label="breadcrumb ">
    ...
    <div class=" w-100 mx-auto p-3 shadow rounded-3  bg-white">
        <a href="{{ route('admin.categories.create') }}"  class="btn mb-3 btn-primary">{{ __('admin.Add') }}</a>
            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td>{{ $category->name }}</td>
                        <td>
                            <a class="btn btn-info btn-sm" href="{{ route('admin.categories.edit',$category) }}">{{ __('admin.Update') }}</a>
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                data-bs-target="#delete_agent{{ $category->id }}"><i></i>
                                {{ __('admin.Delete') }}
                            </button>
