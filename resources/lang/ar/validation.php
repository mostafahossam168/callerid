...
return [
    ...
    'attributes'           => [
        ...
        'reason' => 'السبب',
        'user_id' => 'الموظف',
        'file_name' => 'اسم المرفق',
        'file' => ' المرفق',
        'notes' => 'الملاحظات',
        'name' => 'الاسم',
        "category_child_id" => "القسم الرئيسي",
        "qty" => "العدد",
        'department_id' => 'القسم',
        'main_cat' => 'القسم الرئيسي',
        'kind_id' => 'الصنف الفرعي',
        'category_id' => 'القسم الفرعي',
        'quantity' => 'الكمية',
        'purchase_price' => 'سعر الشراء',
        'importFile' => 'استدعاء ملف',
        'patient' => 'المالك',
        'total' => 'الإجمالي',
        'cash' => 'المدفوع نقدا',
        'card' => 'المدفوع شبكة',
        ...
        'diagnosis.current_symptoms' => 'التاريخ المرضي',
        'diagnosis.clinical_examination' => 'الفحص السريري',
        ...
        'room_id' => 'رقم الغرفة',
        'selected_department_id' => 'القسم',
        'product_id' => 'الخدمة',
        'dr_content' => 'تقرير الطبيب',
        'scan_product_id' => 'خدمة الاشعة',
        'animal_id' => 'اختر الأليف',
        'bank' => 'بنك',
        'visa' => 'كارت مشتريات',
